...
INSERT INTO `tb_logs` VALUES (1,'tb_users','Create','root@localhost','Usuario creado. ID=1, email=carlos.ramirez@ejemplo.com, nickname=Carlos','2026-09-10 11:05:11',_binary ''),(2,'tb_users','Create','root@localhost','Usuario creado. ID=2, email=ana.valdez@ejemplo.com, nickname=Ana','2026-09-10 11:09:37',_binary ''),(3,'tb_users','Create','root@localhost','Usuario creado. ID=3, email=miguel.angel@ejemplo.com, nickname=Miguel','2026-09-10 11:09:37',_binary ''),(4,'tb_users','Create','root@localhost','Usuario creado. ID=4, email=sofia.torres@ejemplo.com, nickname=Sofia','2026-09-10 11:09:37',_binary ''),(5,'tb_users','Create','root@localhost','Usuario creado. ID=5, email=diego.luna@ejemplo.com, nickname=Diego','2026-09-10 11:09:37',_binary ''),(6,'tb_users','Create','root@localhost','Usuario creado. ID=6, email=laura.gomez@ejemplo.com, nickname=Laura','2026-09-10 11:09:37',_binary ''),(7,'tb_users','Create','admin.sistema@192.168.1.173','Usuario creado. ID=7, email=pedro.perez@ejemplo.com, nickname=Pedro','2026-09-10 11:45:41',_binary ''),(8,'tb_users','Delete','admin.sistema@192.168.1.173','Usuario eliminado. ID=3, email=miguel.angel@ejemplo.com, nickname=Miguel','2026-09-10 11:48:05',_binary ''),(16,'tb_products','Create','uriel.gonzalez.izquierda@192.168.1.85','Producto creado. ID=13, SKU=PROD-001, nombre=Laptop Asus Vivobook, precio=$12500.50, stock=15','2026-09-21 21:31:45',_binary ''),(17,'tb_products','Create','uriel.gonzalez.izquierda@192.168.1.85','Producto creado. ID=14, SKU=PROD-002, nombre=Mouse Logitech G203, precio=$350.00, stock=40','2026-09-21 21:31:45',_binary ''),(18,'tb_products','Create','uriel.gonzalez.izquierda@192.168.1.85','Producto creado. ID=15, SKU=PROD-003, nombre=Teclado Mecánico, precio=$899.99, stock=10','2026-09-21 21:31:45',_binary ''),(19,'tb_products','Update','uriel.gonzalez.izquierda@192.168.1.85','Producto actualizado. ID=13, SKU=PROD-001, nombre=Laptop Asus Vivobook, precio=$11999.00, stock=13','2026-09-21 21:31:45',_binary ''),(20,'tb_products','Delete','uriel.gonzalez.izquierda@192.168.1.85','Producto eliminado. ID=14, SKU=PROD-002, nombre=Mouse Logitech G203, precio=$350.00, stock=40','2026-09-21 21:31:45',_binary '');
...
INSERT INTO `tb_products` VALUES (13,'PROD-001','Laptop Asus Vivobook','16GB RAM, 512GB SSD',11999.00,13,_binary '','2026-09-21 21:31:45','2026-09-21 21:31:45'),(15,'PROD-003','Teclado Mecánico','Switches red, formato 60%',899.99,10,_binary '','2026-09-21 21:31:45','2026-09-21 21:31:45');
...
-- Dump completed on 2026-09-21 21:39:58
